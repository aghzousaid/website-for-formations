...
?>  
                    ...
                    if($_POST['theme'] != 'PAR THÈME') { 
                        ...
                        if( $t>0){
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <script>
                                    function OpenNewTab(){
                                        var tmp = '<?php echo 'see_more_elearning.php?theme='.$theme.'&titre='.$row['titre'].'&duree='.$row['duree'].'&public='.$row['public'].'' ?>';
                                ...
                                echo "<br><br><div  onclick='OpenNewTab()' id='img_div' >";
                                    ...
                                    echo"<div id='info'>";
                                        ...
                                        echo "<p>".$row['public']."</p>";
                                        echo'<a id="link" href="see_more_elearning.php?theme='.$theme.'&titre='.$row['titre'].'&duree='.$row['duree'].'&public='.$row['public'].'">En savoir plus</a>';
                                    echo "</div>";
                                echo "</div>";
                            }
                        }
                        ...
                        if($t>0){
                            $result =  mysqli_query($db, "SELECT * FROM elearning where (public='$public' or public1='$public' or public2='$public')");
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <script>
                                    function OpenNewTab1(){
                                        var tmp = '<?php echo 'see_more_elearning.php?theme='.$row['theme'].'&titre='.$row['titre'].'&duree='.$row['duree'].'&public='.$row['public'].'' ?>';
                                        window.location.href =tmp;
                                    }
                                </script>
                                <?php
                                ...
                                echo "<br><br><div  onclick='OpenNewTab1()'  id='img_div'>";
                                    ...
                                    echo"<div id='info'>";
                                        ...
                                        echo "<p>".$row['duree']."h</p>";
                                        echo "<p>".$row['public']."</p>";
                                        echo'<a href="see_more_elearning.php?theme='.$row['theme'].'&titre='.$row['titre'].'&duree='.$row['duree'].'&public='.$row['public'].'"> 
                                        En savoir plus</a><br>';
                                    echo'</div>';
                                echo "</div>";
                            }
        ...
        <div  class="container " id="row_res_elearning">
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                echo "<br><br><div onclick='OpenNewTab()'  id='img_div'>";
                                    ...
                                    echo"<div id='info'>";
                                        ...
                                        echo "<p>".$row['duree']."h</p>";
                                        echo "<p>".$row['public']."</p>";
                                        echo'<a href="see_more_elearning.php?theme='.$theme.'&titre='.$row['titre'].'&duree='.$row['duree'].'&public='.$row['public'].'"> 
                                        En savoir plus</a><br>';
                                    echo'</div>';
                                echo "</div>";
                            }
