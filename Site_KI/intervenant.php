...
?>
    ...
    <div class="container" id="col_cont">
    <div class=" presentation_dev_intervenant " >
    
        <p>“ Kamedis Institut organise chaque année des formations DPC diverses et variées au travers de la France.
        Nos intervenants garantissent le succès de nos formations. Rejoignez l’équipe Kamedis Institut afin 
        de renforcer notre équipe d’experts. ”</p>

    </div> 
    <div class="row" id="expert_defin">
        <div class="col-md-6" id="col1_expert">
        ...
        <div class="col-md-6"  id="devenir_expert">
            <div>
                <img src="img/formateur/education.png" >
            </div>
        </div>
    </div>

    <div  id="pictogramme" class="">
            <div class="item_picto" > 
                    <p><i class="fas fa-check" id="check_inter"></i>Vous contribuez au maintien, à l’actualisation des connaissances et compétences
                    ainsi qu’à l’amélioration des pratiques des professionnels de santé.</p>
            </div>

            <div class="item_picto" id="text_img">
                <p><i class="fas fa-check" id="check_inter"></i>Vous partagez votre savoir-faire ainsi que vos connaissances avec des confrères.</p> 
            </div>   

            <div class="item_picto" id="text_img">
                <p><i class="fas fa-check" id="check_inter"></i>Vous êtes rémunérés sous forme de droits d’auteur pour chaque intervention.</p> 
            </div>   
    </div>
...
<div class="form-row" id="row_form">
    <div class="col" id="input_contact">
        <input  name="nom" type="text" class="form-control" placeholder="Nom *"  value="<?= $name ?>"  required/>
    ...
    <div class="col"  id="input_next" >
        <input  name="prenom" type="text"  class="form-control" placeholder="Prenom *"   value="<?= $prenom ?>" required/>
...
<div class="form-row"  id="row_form">
    <div class="col" id="input_contact">
        ...
        placeholder="Lieu d'exercice, ex : 10 rue ... *" value="<?= $address ?>" required/>
        <div class="error">
        <span ><?= $address_error ?></span>
        </div>
...
<div class="form-row"  id="row_form">
    ...
    <div class="col" id="input_contact">
        <input name="mail" type="email" class="form-control" placeholder="Email *"  onblur="verifieEmail()" value="<?= $email ?>"required/>
        <div class="next_error">
            <span ><?= $email_error ?></span>
        </div>
    </div>
...
<div class="form-inline" >
    <label class="my-1 mr-2" for="Profession">Profession *</label>
    <select class="custom-select my-1 mr-sm-2"  id="clborder" name="Profession" value="<?= $profession ?>" required>
            <option value="" selected >Aucune</option>
            <option value="Médecin">Médecin</option>
            <option value="Inférmier">Inférmier</option>
            <option value="Sage-Femme">Sage-Femme</option>
...
<div class="form-inline" >
    <label class="my-1 mr-2" for="#Profession">Thème d’intervention  *</label>
    <select class="custom-select my-1 mr-sm-2"  id="clborder" name="theme_intervention"  value="<?= $ti ?>"  required>
            <option value="" selected >Aucun</option>
            <option >Douleur et Cancer</option>
            <option >Douleurs migraineuses</option>
            <option >Douleurs neuropathiques</option>
