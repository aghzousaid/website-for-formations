...
if ( ! class_exists( 'Medical_Circle_Theme_Info' ) ) {
    class Medical_Circle_Theme_Info{
        ...
        public function at_theme_info_welcome_admin_notice() {
            ...
            echo ( '<p>' . sprintf( __('Welcome! Thank you for choosing %1$s! To fully take advantage of the best our theme can offer please make sure you visit our %2$swelcome page%3$s.','medical-circle'), $this->theme_name, '<a href="' . esc_url( admin_url( 'themes.php?page=' . $this->theme_slug . '-info' ) ) . '">', '</a>' ) . '</p><p><a href="' . esc_url( admin_url( 'themes.php?page=' . $this->theme_slug . '-info' ) ) . '" class="button">' . sprintf( __('Get started with %s','medical-circle'), $this->theme_name ) . '</a></p>' );
            echo '</div>';
        }
