...
<nav class="navbar navbar-expand-lg navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <!-- <a class="navbar-brand" href="#myPage"><img src="img/logo_kamedis.jpg" height="100" width="250"></a> -->
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="#">Mixtes</a></li>
          </ul>
        </li>
        <li><a href="#myPage">Le DPC</a></li>
        <li><a href="#band">Actualités</a></li>
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">Recrutement
          <span class="caret"></span></a>
          <ul class="dropdown-menu">
        ...
        <li class="dropdown">
          ...
          <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="#">À propos de nos</a></li>
...
$(document).ready(function(){
  ...
  <!-- <a class="navbar-brand" href="#"><img src="img/logo_kamedis.jpg" height="10" width="10" class="logo_ki"></a> -->
    ...
    <ul class="navbar-nav mr-auto" >
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="#">Mixtes</a>
        </div>
      </li> 
      <!-- <li class="nav-item active">
       ...
       <li class="nav-item">
        <a class="nav-link" href="#">Le DPC</a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="#">Devenir Intervenant</a>
          <a class="dropdown-item" href="#">Nous Rejoindre</a>
        </div>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="#">À propos de nos</a>
          <a class="dropdown-item" href="#">Nos valeurs</a>
          <a class="dropdown-item" href="#">Nos formateurs</a>
      ...
      <li class="nav-item">
        ...
        <li class="nav-item"><a class="nav-link"href="#"><span class="glyphicon glyphicon-log-in"></span> Mon compte</a></li> -->
     </ul>
