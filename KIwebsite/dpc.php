...
?>
    ...
    <div class="info_page_elearning">
        ...
        <div class="titre_elearning">
            <div class="shadow-lg p-3 mb-5  rounded"><center><h1 class="titre_body">LE DPC</h1>
    ...
    <div class="row">
        ...
        <div class="col-sm-5" id="lg_odpc">
            <center>
                <a href="https://www.agencedpc.fr/"><img src="img/odpc.jpg" alt="Avatar" class="logo_odpc"></a>
            </center>
        </div>

        <div class="col-sm-7" id="desc_dpc">
            <div class="row" id="first_desc">
            ...
            <div class="row" id="first_desc">
                <p>
                <b>Le DPC permet l’amélioration de la qualité et de la sécurité des soins à travers : </b><br><br>
                <div id="second_desc">
                    •	L’Evaluation et amélioration des pratiques professionnelles et de gestion des risques<br>
                ...
                <div id="dpc_mixte">
                    <div class="row" id="icon_mixte">
                        ...
                        <div id="icon_user" class="col">
                            <center>
                            <i class="user outline icon" style="font-size:75px;" ></i>
                            </center>
                        </div>
